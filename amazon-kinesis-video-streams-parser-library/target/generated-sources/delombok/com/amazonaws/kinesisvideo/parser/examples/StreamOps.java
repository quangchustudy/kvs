...
public class StreamOps extends KinesisVideoCommon {
    ...
    public static class StreamOpsBuilder {
         ...
         */
        @SuppressWarnings("all")
        public StreamOps.StreamOpsBuilder region(final Regions region) {
            this.region = region;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public StreamOps.StreamOpsBuilder streamName(final String streamName) {
            this.streamName = streamName;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public StreamOps.StreamOpsBuilder credentialsProvider(final AWSCredentialsProvider credentialsProvider) {
    ...
    @SuppressWarnings("all")
    public static StreamOps.StreamOpsBuilder builder() {
        return new StreamOps.StreamOpsBuilder();
    }
