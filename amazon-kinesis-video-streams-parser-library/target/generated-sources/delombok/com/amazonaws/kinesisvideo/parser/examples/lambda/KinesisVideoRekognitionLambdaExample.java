...
public final class KinesisVideoRekognitionLambdaExample implements RequestHandler<KinesisEvent, Context> {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(KinesisVideoRekognitionLambdaExample.class);
    ...
    public static void main(final String[] args) throws Exception {
        final KinesisVideoRekognitionLambdaExample KinesisVideoRekognitionLambdaExample = new KinesisVideoRekognitionLambdaExample();
    ...
    private void processRekognizedOutputs() throws InterruptedException {
        ...
        final Optional<FragmentCheckpoint> lastFragmentNumber = fragmentCheckpointManager.getLastProcessedItem(inputKvsStreamName);
        ...
        while (!rekognizedFragmentsIndex.isEmpty()) {
            ...
            try {
                ...
                final GetMediaForFragmentListWorker worker = GetMediaForFragmentListWorker.create(kvsClient.getStreamName(), Collections.singletonList(fragmentNumber), kvsClient.getCredentialsProvider(), kvsClient.getRegion(), kvsClient.getAmazonKinesisVideo(), frameVisitor);
                ...
                fragmentCheckpointManager.saveCheckPoint(inputKvsStreamName, fragmentNumber, rekognizedFragment.getProducerTime(), rekognizedFragment.getServerTime());
    ...
    public void startKDSWorker(final String kdsStreamName) {
        final KinesisDataStreamsWorker kinesisDataStreamsWorker = KinesisDataStreamsWorker.create(Regions.US_WEST_2, credentialsProvider, kdsStreamName, rekognizedFragmentsIndex);
    ...
    public Context handleRequest(final KinesisEvent kinesisEvent, final Context context) {
        try {
            ...
            final List<Record> records = kinesisEvent.getRecords().stream().map(KinesisEvent.KinesisEventRecord::getKinesis).collect(Collectors.toList());
