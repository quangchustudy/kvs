...
public class MergedOutputPiper extends GetMediaResponseStreamConsumer {
    ...
    @Override
    public void process(final InputStream inputStream, FragmentMetadataCallback endOfFragmentCallback) throws MkvElementVisitException, IOException {
    ...
    public MergedOutputPiper(final ProcessBuilder childProcessBuilder) {
