...
public class BoundingBoxImagePanel extends ImagePanel {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(BoundingBoxImagePanel.class);
    ...
    public void processRekognitionOutput(final Graphics2D g2, final int width, final int height, final RekognizedOutput rekognizedOutput) {
        if (rekognizedOutput != null) {
            ...
            if (rekognizedOutput.getFaceSearchOutputs() != null) {
                ...
                for (final RekognizedOutput.FaceSearchOutput faceSearchOutput : rekognizedOutput.getFaceSearchOutputs()) {
                    ...
                    drawFaces(g2, width, height, faceSearchOutput.getDetectedFace().getBoundingBox(), title, detectedFaceType.getColor());
                }
            }
        }
    }

    private void drawFaces(final Graphics2D g2, final int width, final int height, final BoundingBox boundingBox, final String personName, final Color color) {
    ...
    private void drawFaceTitle(final Graphics2D g2, final int width, final int height, final BoundingBox boundingBox, final String personName) {
        final int left = (int) (boundingBox.getLeft() * width);
        final int top = (int) (boundingBox.getTop() * height);
        g2.drawString(personName, left, top);
    }

    private void drawBoundingBox(final Graphics2D g2, final int width, final int height, final BoundingBox boundingBox) {
        final int left = (int) (boundingBox.getLeft() * width);
        final int top = (int) (boundingBox.getTop() * height);
