...
public class FrameVisitor extends CompositeMkvElementVisitor {
    ...
    private FrameVisitor(final FragmentMetadataVisitor fragmentMetadataVisitor, final Optional<FragmentMetadataVisitor.MkvTagProcessor> tagProcessor, final FrameProcessor frameProcessor, final Optional<Long> trackNumber) {
    ...
    public static FrameVisitor create(final FrameProcessor frameProcessor, final Optional<FragmentMetadataVisitor.MkvTagProcessor> tagProcessor) {
        return new FrameVisitor(FragmentMetadataVisitor.create(tagProcessor), tagProcessor, frameProcessor, Optional.empty());
    }

    public static FrameVisitor create(final FrameProcessor frameProcessor, final Optional<FragmentMetadataVisitor.MkvTagProcessor> tagProcessor, final Optional<Long> trackNumber) {
    ...
    public interface FrameProcessor extends AutoCloseable {
        default void process(final Frame frame, final MkvTrackMetadata trackMetadata, final Optional<FragmentMetadata> fragmentMetadata) throws FrameProcessException {
            throw new NotImplementedException("Default FrameVisitor.FrameProcessor");
        }

        default void process(final Frame frame, final MkvTrackMetadata trackMetadata, final Optional<FragmentMetadata> fragmentMetadata, final Optional<FragmentMetadataVisitor.MkvTagProcessor> tagProcessor) throws FrameProcessException {
        ...
        default void process(final Frame frame, final MkvTrackMetadata trackMetadata, final Optional<FragmentMetadata> fragmentMetadata, final Optional<FragmentMetadataVisitor.MkvTagProcessor> tagProcessor, final Optional<BigInteger> timescale, final Optional<BigInteger> fragmentTimecode) throws FrameProcessException {
    ...
    private class FrameVisitorInternal extends MkvElementVisitor {
        ...
        public void visit(final com.amazonaws.kinesisvideo.parser.mkv.MkvEndMasterElement endMasterElement) throws com.amazonaws.kinesisvideo.parser.mkv.MkvElementVisitException {
            if (tagProcessor.isPresent() && MkvTypeInfos.CLUSTER.equals(endMasterElement.getElementMetaData().getTypeInfo())) {
        ...
        public void visit(final com.amazonaws.kinesisvideo.parser.mkv.MkvDataElement dataElement) throws com.amazonaws.kinesisvideo.parser.mkv.MkvElementVisitException {
            ...
            if (MkvTypeInfos.SIMPLEBLOCK.equals(dataElement.getElementMetaData().getTypeInfo())) {
                ...
                final MkvTrackMetadata trackMetadata = fragmentMetadataVisitor.getMkvTrackMetadata(frameTrackNo);
                if (trackNumber.orElse(frameTrackNo) == frameTrackNo) {
                    frameProcessor.process(frame.getVal(), trackMetadata, fragmentMetadataVisitor.getCurrentFragmentMetadata(), tagProcessor, timescale, fragmentTimecode);
                }
            }
        }
    }
